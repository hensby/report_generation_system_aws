...
public class ReportController {
    ...
    public ResponseEntity<GeneralResponse> deleteReq(@PathVariable String reqId) {
        GeneralResponse gb = new GeneralResponse();
        log.debug("Got Request to Delete File - reqid: {}", reqId);
//        try {
            reportService.deleteReport(reqId);
            gb.setData("delete success");
//        } catch (Exception ex) {
//            log.error("delete failed");
//            gb.setData("delete failed");
//            gb.setStatusCode(HttpStatus.NOT_FOUND);
//        }
